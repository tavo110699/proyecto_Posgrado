...
(function (l) {
  ...
  function Bb(a, b, c, d, e, h) {
    ...
    for (; d !== e;) {
      a.hasOwnProperty(d) && (f = g ? b(f, a[d], d, a) : a[d], g = !0, d += h);
    }
    ...
    if (b) for (e = b.length - 1; 0 <= e; e--) {
      ...
      for (h = n.length; m < h; m++) {
        if ("number" === typeof n[m] && 0 <= n[m]) {
          ...
          d(n[m], k);
        } else if ("number" === typeof n[m] && 0 > n[m]) d(f.length + n[m], k);else if ("string" === typeof n[m]) {
          var p = 0;
  ...
  function T(a, b, c, d) {
    ...
    if ((k === g || null === k) && null !== f && d !== q) k = f;else if ("function" === typeof k) return k.call(g);
  ...
  function wa(a, b, c, d) {
    ...
    if ("dom" !== c && (c && "auto" !== c || "dom" !== e.src)) {
      var f = e.anCells;
      if (f) if (d !== q) g(f[d], d);else for (c = 0, h = f.length; c < h; c++) {
        g(f[c], c);
      }
  ...
  function Eb(a) {
    ...
    if (null !== e) for (a = a.aoFooter[0], k = 0, b = a.length; k < b; k++) {
      n = f[k], n.nTf = a[k].cell, n.sClass && l(n.nTf).addClass(n.sClass);
    }
  }
      ...
      for (d = h.length; k < d; k++) {
        ...
        for (b = h[k].length; e < b; e++) {
          ...
          if (g[k][e] === q) {
            ...
            for (g[k][e] = 1; h[k + f] !== q && h[k][e].cell == h[k + f][e].cell;) {
              g[k + f][e] = 1, f++;
            }
  ...
  function Hb(a) {
    ...
    for (var h = a.sDom.split(""), g, f, k, n, m, p, t = 0; t < h.length; t++) {
      ...
      if ("<" == f) {
        ...
        e.append(k);
        e = l(k);
      } else if (">" == f) e = e.parent();else if ("l" == f && d.bPaginate && d.bLengthChange) g = Ib(a);else if ("f" == f && d.bFilter) g = Jb(a);else if ("r" == f && d.bProcessing) g = Kb(a);else if ("t" == f) g = Lb(a);else if ("i" == f && d.bInfo) g = Mb(a);else if ("p" == f && d.bPaginate) g = Nb(a);else if (0 !== u.ext.feature.length) for (k = u.ext.feature, p = 0, n = k.length; p < n; p++) {
        if (f == k[p].cFeature) {
          g = k[p].fnInit(a);
          break;
        }
  ...
  function Jb(a) {
    ...
    var n = l("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", h ? gb(k, h) : k).on("mouseup", function (m) {
      setTimeout(function () {
        k.call(n[0], m);
      }, 10);
  ...
  function Sb(a) {
    for (var b = u.ext.search, c = a.aiDisplay, d, e, h = 0, g = b.length; h < g; h++) {
      for (var f = [], k = 0, n = c.length; k < n; k++) {
        e = c[k], d = a.aoData[e], b[h](a, d._aFilterData, e, d._aData, k) && f.push(e);
      }
  ...
  function Lb(a) {
    ...
    k = l("<div/>", {
      ...
      width: c.sXInner || "100%"
    }).append(k.removeAttr("id").css("margin-left", 0).append("top" === f ? g : null).append(b.children("thead"))))).append(l("<div/>", {
      "class": h.sScrollBody
    }).css({
      position: "relative",
      overflow: "auto",
  ...
  function ca(a, b, c) {
    for (var d = 0, e = 0, h = b.length, g, f; e < h;) {
      ...
      for (f = c ? c[e].firstChild : null; g;) {
        1 === g.nodeType && (c ? a(g, f, d) : a(g, d), d++), g = g.nextSibling, f = c ? f.nextSibling : null;
      }
  ...
  function Ya(a) {
    ...
    if (d || !t && !h && !e && f == oa(a) && f == n.length) for (v = 0; v < f; v++) {
      ...
      for (v = 0; v < k.length; v++) {
        w = c[k[v]], n[v].style.width = null !== w.sWidthOrig && "" !== w.sWidthOrig ? K(w.sWidthOrig) : "", w.sWidthOrig && h && l(n[v]).append(l("<div/>").css({
          width: w.sWidthOrig,
          margin: 0,
          padding: 0,
          border: 0,
      ...
      if (a.aoData.length) for (v = 0; v < k.length; v++) {
        t = k[v], w = c[t], l(Zb(a, t)).clone(!1).append(w.sContentPadding).appendTo(r);
      }
      ...
      for (v = e = 0; v < k.length; v++) {
        p = l(n[v]), g = p.outerWidth() - p.width(), p = x.bBounding ? Math.ceil(n[v].getBoundingClientRect().width) : p.outerWidth(), e += p, c[k[v]].sWidth = K(p - g);
      }
  ...
  function $b(a, b) {
    for (var c, d = -1, e = -1, h = 0, g = a.aoData.length; h < g; h++) {
      c = T(a, h, b, "display") + "", c = c.replace(rc, ""), c = c.replace(/&nbsp;/g, " "), c.length > d && (d = c.length, e = h);
    }
  ...
  function Gb(a) {
    ...
    if ("ssp" != Q(a) && 0 !== f.length) {
      ...
      h === f.length ? g.sort(function (m, p) {
        var t,
            v = f.length,
            x = e[m]._aSortData,
            w = e[p]._aSortData;
  ...
  function Ra(a) {
    ...
    if (e.bSort && e.bSortClasses) {
      ...
      for (h = d.length; e < h; e++) {
        g = d[e].src, l(U(a.aoData, "anCells", g)).addClass(c + (2 > e ? e + 1 : 3));
      }
    }
    ...
    b = function b(f) {
      if (f && f.time) {
        ...
        if (-1 === l.inArray(!1, k) && (k = a.iStateDuration, !(0 < k && f.time < +new Date() - 1E3 * k || f.columns && h.length !== f.columns.length))) {
          ...
          if (f.columns) for (d = 0, e = f.columns.length; d < e; d++) {
            k = f.columns[d], k.visible !== q && (h[d].bVisible = k.visible), k.search !== q && l.extend(a.aoPreSearchCols[d], Vb(k.search));
          }
  ...
  var u = function u(a, b) {
    ...
    this.each(function () {
      ...
      if ("table" != this.nodeName.toLowerCase()) da(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);else {
        ...
        if (null === f.aoColumns) for (v = [], k = 0, n = g.length; k < n; k++) {
          v.push(null);
        } else v = f.aoColumns;
        k = 0;
        ...
        g = function g() {
          ...
          if (f.aaData) for (k = 0; k < f.aaData.length; k++) {
            ia(r, f.aaData[k]);
      ...
      var b = function b(c, d, e) {
        ...
        for (var g, f, k = 0, n = e.length - 1; k < n; k++) {
          ...
          if (g) {
            ...
            h.splice(0, k + 1);
            g = h.join(".");
            if (Array.isArray(d)) for (f = 0, n = d.length; f < n; f++) {
        ...
        if ("" !== h) {
          ...
          for (var f = 0, k = g.length; f < k; f++) {
            ...
            if (h) {
              ...
              g.splice(0, f + 1);
              g = g.join(".");
              if (Array.isArray(d)) for (f = 0, k = d.length; f < k; f++) {
                n.push(c(d[f], e, g));
              }
      ...
      for (h = f.length; m < h; m++) {
        ...
        if ("table" === b) {
          ...
          for (g = v.length; x < g; x++) {
            t = v[x], t = "cell" === b ? c.call(p, f[m], t.row, t.column, m, x) : c.call(p, f[m], t, m, x, k), t !== q && e.push(t);
          }
        }
      }
  ...
  var tb = function tb(a, b, c, d, e) {
    ...
    for (f = b.length; n < f; n++) {
      ...
      for (k = m.length; p < k; p++) {
        (g = c("string" === typeof m[p] ? m[p].trim() : m[p])) && g.length && (h = h.concat(g));
      }
    }

    a = M.selector[a];
    if (a.length) for (n = 0, f = a.length; n < f; n++) {
      h = a[n](d, e, h);
    }
    return Ma(h);
  },
    ...
    if ("current" == b) for (g = a._iDisplayStart, a = a.fnDisplayEnd(); g < a; g++) {
      ...
      "none" == h ? c.push(g) : (e = l.inArray(g, d), (-1 === e && "removed" == h || 0 <= e && "applied" == h) && c.push(g));
    }
    return c;
  },
  ...
  var wc = function wc(a, b, c, d) {
    var e = [],
        h = function h(g, f) {
      if (Array.isArray(g) || g instanceof l) for (var k = 0, n = g.length; k < n; k++) {
        h(g[k], f);
    ...
    if (c.length && a.length) {
      ...
      d._details && ((d._detailsShow = b) ? (d._details.insertAfter(d.nTr), l(d.nTr).addClass("dt-hasChild")) : (d._details.detach(), l(d.nTr).removeClass("dt-hasChild")), F(c[0], null, "childRow", [b, a.row(a[0])]), xc(c[0]), qa(c[0]));
    }
  },
      xc = function xc(a) {
    var b = new B(a),
    ...
    0 < U(c, "_details").length && (b.on("draw.dt.DT_details", function (d, e) {
      ...
      if (a === e) for (e = oa(e), h = 0, g = c.length; h < g; h++) {
  ...
  l.extend(!0, u.ext.renderer, {
    header: {
      ...
      jqueryui: function jqueryui(a, b, c, d) {
        ...
        l(a.nTable).on("order.dt.DT", function (e, h, g, f) {
          a === h && (e = c.idx, b.removeClass(d.sSortAsc + " " + d.sSortDesc).addClass("asc" == f[e] ? d.sSortAsc : "desc" == f[e] ? d.sSortDesc : c.sSortingClass), b.find("span." + d.sSortIcon).removeClass(d.sSortJUIAsc + " " + d.sSortJUIDesc + " " + d.sSortJUI + " " + d.sSortJUIAscAllowed + " " + d.sSortJUIDescAllowed).addClass("asc" == f[e] ? d.sSortJUIAsc : "desc" == f[e] ? d.sSortJUIDesc : c.sSortingClassJUI));
        });
      }
    }
  });
